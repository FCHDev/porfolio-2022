...
const SocialLogos = () => {
    return (
        <div className="logos-social">
            <a href="https://www.linkedin.com/in/frachevalier/"
                // eslint-disable-next-line
               target="_blank"
               rel="noreferrer"
            >
                <img src={linkedIn} alt="linkedin françois chevalier développeur React"/>
            </a>

            <a href="https://www.malt.fr/profile/francoischevalier?overview=true"
                // eslint-disable-next-line
               target="_blank"
               rel="noreferrer"
            >
